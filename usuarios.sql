...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2020 a las 00:52:05
...
(1, 'user@mail.com', 'gggla', '1234', 'admin'),
(2, 'pepe@mail.com', 'pepe', '123456', 'alumno');
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `indiceemail` (`email`),
  ADD UNIQUE KEY `indicenombre` (`nombre`);
